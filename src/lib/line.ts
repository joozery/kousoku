        ...
        contents: [
          {
            ...
            action: {
              ...
              uri: `${process.env.NEXT_PUBLIC_APP_URL ?? 'https://kosoku.com'}/booking/confirm?ref=${booking.ref}`,
            },
            style: 'primary',
            color: '#16a34a',
            height: 'md',
  ...
  return {
    ...
    contents: {
      ...
      header: {
        ...
        paddingBottom: '18px',
        contents: [
          { type: 'text', text: 'Kosoku', color: '#bbf7d0', size: 'sm', weight: 'bold' },
        ...
        contents: [
          {
            ...
            action: {
              type: 'uri',
              label: 'ยืนยันการจอง / ชำระมัดจำ',
              uri: `${process.env.NEXT_PUBLIC_APP_URL ?? 'https://kosoku.com'}/booking/success?ref=${primary.orderRef}`,
            },
            style: 'primary',
            color: '#16a34a',
            height: 'md',
