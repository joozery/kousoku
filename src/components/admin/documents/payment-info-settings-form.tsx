      ...
      <form action={formAction} className="bg-white border border-slate-100 rounded-2xl p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="bankAccountName" defaultValue={settings.bankAccountName} placeholder="บริษัท โคโซคุ (ไทยแลนด์) จำกัด" className={inputCls} />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea name="paymentNote" defaultValue={settings.paymentNote} rows={2} placeholder="เช่น โอนแล้วกรุณาแจ้งสลิปทาง LINE @kosoku เพื่อยืนยันการสั่งซื้อ"
