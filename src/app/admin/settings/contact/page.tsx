      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          ...
          <div className="grid md:grid-cols-2 gap-x-6 gap-y-4">
            {([
              { name: 'lineUrl',      icon: 'lineIcon',      label: 'ลิงก์ LINE',       placeholder: 'https://line.me/R/ti/p/%40kosoku (เว้นว่าง = สร้างจาก LINE ID อัตโนมัติ)' },
              { name: 'facebookUrl',  icon: 'facebookIcon',  label: 'เพจ Facebook',     placeholder: 'https://www.facebook.com/kosoku' },
              { name: 'instagramUrl', icon: 'instagramIcon', label: 'Instagram (ไอจี)', placeholder: 'https://www.instagram.com/kosoku' },
              { name: 'tiktokUrl',    icon: 'tiktokIcon',    label: 'TikTok (ติ๊กต๊อก)', placeholder: 'https://www.tiktok.com/@kosoku' },
              { name: 'shopeeUrl',    icon: 'shopeeIcon',    label: 'Shopee (ช้อปปี้)',  placeholder: 'https://shopee.co.th/kosoku' },
